package taeeun.hello.spring4.aop;
...
public class MemberServiceAdvice {
    ...
    @Pointcut("execution(* taeeun.hello.spring4.controller.MemberController.myinfo(..))")
    public void myInfoPoint() { }

    @Pointcut("execution(* taeeun.hello.spring4.controller.MemberController.join(..))")
    public void joinPoint() { }

    // ( )안은 매개변수 목록, MemberController.myinfo에 advice를 적용.
    @Around("myInfoPoint()")
